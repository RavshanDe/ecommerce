          ...
          <div className="row ">
            <div className="col-6">
              <p className="text-white mb-0">
                1.000.000 dan oshsa yetkazib berish tekin
              </p>
            </div>
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Tel:
                <a href="tel:998 939984108" className="text-white">
                  93 998 41 08
                </a>
              </p>
            </div>
              ...
              <div className="header-upper-links d-flex align-items-center justify-content-between">
                ...
                <div className="d-flex align-items-center ">
                  <Link
                    ...
                    className="d-flex align-items-center gap-10 text-white"
                  >
                    <img src="/images/cart.svg" alt="images"></img>
                    <p>
                ...
                <div>
                  <div className="dropdown">
                    <button
                      ...
                      aria-expanded="false"
                    >
                      <span className="d-inline-block me-5">Kategoriyalar</span>
                    </button>
